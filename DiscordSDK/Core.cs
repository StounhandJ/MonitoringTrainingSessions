...
public partial class Discord : IDisposable
{
    ...
    private readonly static FFIMethods.SetLogHookCallback SetLogHookCallbackDelegate =
        new FFIMethods.SetLogHookCallback(SetLogHookCallbackImpl);
...
public partial class ApplicationManager
{
    ...
    private readonly static FFIMethods.ValidateOrExitCallback ValidateOrExitCallbackDelegate =
        new FFIMethods.ValidateOrExitCallback(ValidateOrExitCallbackImpl);
    ...
    private readonly static FFIMethods.GetOAuth2TokenCallback GetOAuth2TokenCallbackDelegate =
        new FFIMethods.GetOAuth2TokenCallback(GetOAuth2TokenCallbackImpl);
    ...
    private readonly static FFIMethods.GetTicketCallback GetTicketCallbackDelegate =
        new FFIMethods.GetTicketCallback(GetTicketCallbackImpl);
}
...
public partial class UserManager
{
    ...
    private readonly static FFIMethods.GetUserCallback GetUserCallbackDelegate =
        new FFIMethods.GetUserCallback(GetUserCallbackImpl);
...
public partial class ImageManager
{
    ...
    private readonly static FFIMethods.FetchCallback FetchCallbackDelegate =
        new FFIMethods.FetchCallback(FetchCallbackImpl);
...
public partial class ActivityManager
{
    ...
    internal partial struct FFIMethods
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void SendRequestReplyMethod(IntPtr methodsPtr, Int64 userId, ActivityJoinRequestReply reply,
    ...
    {
        GCHandle wrapped = GCHandle.Alloc(callback);
        Methods.UpdateActivity(MethodsPtr, ref activity, GCHandle.ToIntPtr(wrapped),
            updateActivityCallback = UpdateActivityCallbackImpl);
    }

    private readonly static FFIMethods.UpdateActivityCallback UpdateActivityCallbackDelegate =
        new FFIMethods.UpdateActivityCallback(UpdateActivityCallbackImpl);
    ...
    private readonly static FFIMethods.ClearActivityCallback ClearActivityCallbackDelegate =
        new FFIMethods.ClearActivityCallback(ClearActivityCallbackImpl);
    ...
    public void SendRequestReply(Int64 userId, ActivityJoinRequestReply reply, SendRequestReplyHandler callback)
    {
        ...
        Methods.SendRequestReply(MethodsPtr, userId, reply, GCHandle.ToIntPtr(wrapped),
            SendRequestReplyCallbackDelegate);
    }

    private readonly static FFIMethods.SendRequestReplyCallback SendRequestReplyCallbackDelegate =
        new FFIMethods.SendRequestReplyCallback(SendRequestReplyCallbackImpl);
    ...
    private readonly static FFIMethods.SendInviteCallback SendInviteCallbackDelegate =
        new FFIMethods.SendInviteCallback(SendInviteCallbackImpl);
    ...
    private readonly static FFIMethods.AcceptInviteCallback AcceptInviteCallbackDelegate =
        new FFIMethods.AcceptInviteCallback(AcceptInviteCallbackImpl);
...
public partial class RelationshipManager
{
    ...
    private readonly static FFIMethods.FilterCallback FilterCallbackDelegate =
        new FFIMethods.FilterCallback(FilterCallbackImpl);
...
public partial class LobbyManager
{
    ...
    internal partial struct FFIMethods
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate Result GetMemberMetadataKeyMethod(IntPtr methodsPtr, Int64 lobbyId, Int64 userId, Int32 index,
            StringBuilder key);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void UpdateMemberMethod(IntPtr methodsPtr, Int64 lobbyId, Int64 userId, IntPtr transaction,
    ...
    public void CreateLobby(LobbyTransaction transaction, CreateLobbyHandler callback)
    {
        ...
        Methods.CreateLobby(MethodsPtr, transaction.MethodsPtr, GCHandle.ToIntPtr(wrapped),
            CreateLobbyCallbackDelegate);
        transaction.MethodsPtr = IntPtr.Zero;
    }

    private readonly static FFIMethods.CreateLobbyCallback CreateLobbyCallbackDelegate =
        new FFIMethods.CreateLobbyCallback(CreateLobbyCallbackImpl);
    ...
    public void UpdateLobby(Int64 lobbyId, LobbyTransaction transaction, UpdateLobbyHandler callback)
    {
        ...
        Methods.UpdateLobby(MethodsPtr, lobbyId, transaction.MethodsPtr, GCHandle.ToIntPtr(wrapped),
            UpdateLobbyCallbackDelegate);
        transaction.MethodsPtr = IntPtr.Zero;
    }

    private readonly static FFIMethods.UpdateLobbyCallback UpdateLobbyCallbackDelegate =
        new FFIMethods.UpdateLobbyCallback(UpdateLobbyCallbackImpl);
    ...
    private readonly static FFIMethods.DeleteLobbyCallback DeleteLobbyCallbackDelegate =
        new FFIMethods.DeleteLobbyCallback(DeleteLobbyCallbackImpl);
    ...
    private readonly static FFIMethods.ConnectLobbyCallback connectLobbyCallback =
        new FFIMethods.ConnectLobbyCallback(ConnectLobbyCallbackImpl);
    ...
    public void ConnectLobbyWithActivitySecret(string activitySecret, ConnectLobbyWithActivitySecretHandler callback)
    {
        ...
        Methods.ConnectLobbyWithActivitySecret(MethodsPtr, activitySecret, GCHandle.ToIntPtr(wrapped),
            ConnectLobbyWithActivitySecretCallbackDelegate);
    }

    private readonly static FFIMethods.ConnectLobbyWithActivitySecretCallback
        ConnectLobbyWithActivitySecretCallbackDelegate =
            new FFIMethods.ConnectLobbyWithActivitySecretCallback(ConnectLobbyWithActivitySecretCallbackImpl);
    ...
    private readonly static FFIMethods.DisconnectLobbyCallback DisconnectLobbyCallbackDelegate =
        new FFIMethods.DisconnectLobbyCallback(DisconnectLobbyCallbackImpl);
        ...
        UpdateMemberHandler callback)
    {
        ...
        Methods.UpdateMember(MethodsPtr, lobbyId, userId, transaction.MethodsPtr, GCHandle.ToIntPtr(wrapped),
            UpdateMemberCallbackDelegate);
        transaction.MethodsPtr = IntPtr.Zero;
    }

    private readonly static FFIMethods.UpdateMemberCallback UpdateMemberCallbackDelegate =
        new FFIMethods.UpdateMemberCallback(UpdateMemberCallbackImpl);
    ...
    public void SendLobbyMessage(Int64 lobbyId, byte[] data, SendLobbyMessageHandler callback)
    {
        ...
        Methods.SendLobbyMessage(MethodsPtr, lobbyId, data, data.Length, GCHandle.ToIntPtr(wrapped),
            SendLobbyMessageCallbackDelegate);
    }

    private readonly static FFIMethods.SendLobbyMessageCallback SendLobbyMessageCallbackDelegate =
        new FFIMethods.SendLobbyMessageCallback(SendLobbyMessageCallbackImpl);
    ...
    private readonly static FFIMethods.SearchCallback SearchCallbackDelegate =
        new FFIMethods.SearchCallback(SearchCallbackImpl);
    ...
    private readonly static FFIMethods.ConnectVoiceCallback ConnectVoiceCallbackDelegate =
        new FFIMethods.ConnectVoiceCallback(ConnectVoiceCallbackImpl);
    ...
    private readonly static FFIMethods.DisconnectVoiceCallback DisconnectVoiceCallbackDelegate =
        new FFIMethods.DisconnectVoiceCallback(DisconnectVoiceCallbackImpl);
    ...
    [MonoPInvokeCallback]
    private static void OnNetworkMessageImpl(IntPtr ptr, Int64 lobbyId, Int64 userId, byte channelId, IntPtr dataPtr,
        Int32 dataLen)
    {
        GCHandle h = GCHandle.FromIntPtr(ptr);
        Discord d = (Discord)h.Target;
...
public partial class OverlayManager
{
    ...
    private readonly static FFIMethods.SetLockedCallback SetLockedCallbackDelegate =
        new FFIMethods.SetLockedCallback(SetLockedCallbackImpl);
    ...
    private readonly static FFIMethods.OpenActivityInviteCallback OpenActivityInviteCallbackDelegate =
        new FFIMethods.OpenActivityInviteCallback(OpenActivityInviteCallbackImpl);
    ...
    private readonly static FFIMethods.OpenGuildInviteCallback OpenGuildInviteCallbackDelegate =
        new FFIMethods.OpenGuildInviteCallback(OpenGuildInviteCallbackImpl);
    ...
    private readonly static FFIMethods.OpenVoiceSettingsCallback OpenVoiceSettingsCallbackDelegate =
        new FFIMethods.OpenVoiceSettingsCallback(OpenVoiceSettingsCallbackImpl);
...
public partial class StorageManager
{
    ...
    internal partial struct FFIMethods
    {
        ...
        internal delegate void ReadAsyncPartialMethod(IntPtr methodsPtr, [MarshalAs(UnmanagedType.LPStr)] string name,
            UInt64 offset, UInt64 length, IntPtr callbackData, ReadAsyncPartialCallback callback);
    ...
    private readonly static FFIMethods.ReadAsyncCallback ReadAsyncCallbackDelegate =
        new FFIMethods.ReadAsyncCallback(ReadAsyncCallbackImpl);
    ...
    public void ReadAsyncPartial(string name, UInt64 offset, UInt64 length, ReadAsyncPartialHandler callback)
    {
        ...
        Methods.ReadAsyncPartial(MethodsPtr, name, offset, length, GCHandle.ToIntPtr(wrapped),
            ReadAsyncPartialCallbackDelegate);
    }

    private readonly static FFIMethods.ReadAsyncPartialCallback ReadAsyncPartialCallbackDelegate =
        new FFIMethods.ReadAsyncPartialCallback(ReadAsyncPartialCallbackImpl);
    ...
    private readonly static FFIMethods.WriteAsyncCallback WriteAsyncCallbackDelegate =
        new FFIMethods.WriteAsyncCallback(WriteAsyncCallbackImpl);
...
public partial class StoreManager
{
    ...
    private readonly static FFIMethods.FetchSkusCallback FetchSkusCallbackDelegate =
        new FFIMethods.FetchSkusCallback(FetchSkusCallbackImpl);
    ...
    private readonly static FFIMethods.FetchEntitlementsCallback FetchEntitlementsCallbackDelegate =
        new FFIMethods.FetchEntitlementsCallback(FetchEntitlementsCallbackImpl);
    ...
    private readonly static FFIMethods.StartPurchaseCallback StartPurchaseCallbackDelegate =
        new FFIMethods.StartPurchaseCallback(StartPurchaseCallbackImpl);
...
public partial class VoiceManager
{
    ...
    private readonly static FFIMethods.SetInputModeCallback SetInputModeCallbackDelegate =
        new FFIMethods.SetInputModeCallback(SetInputModeCallbackImpl);
...
public partial class AchievementManager
{
    ...
    internal partial struct FFIMethods
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void SetUserAchievementMethod(IntPtr methodsPtr, Int64 achievementId, byte percentComplete,
    ...
    public void SetUserAchievement(Int64 achievementId, byte percentComplete, SetUserAchievementHandler callback)
    {
        ...
        Methods.SetUserAchievement(MethodsPtr, achievementId, percentComplete, GCHandle.ToIntPtr(wrapped),
            SetUserAchievementCallbackDelegate);
    }

    private readonly static FFIMethods.SetUserAchievementCallback SetUserAchievementCallbackDelegate =
        new FFIMethods.SetUserAchievementCallback(SetUserAchievementCallbackImpl);
    ...
    private readonly static FFIMethods.FetchUserAchievementsCallback FetchUserAchievementsCallbackDelegate =
        new FFIMethods.FetchUserAchievementsCallback(FetchUserAchievementsCallbackImpl);
